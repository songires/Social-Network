...
<body>
	...
	<nav class="navbar navbar-inverse">
 	 ...
 	 <div class="container" style="padding-left:25px;">  	
			<a href="othersBackgroundPicture"><img src="data:image/jpeg;base64,${otherProfilePage.backgroundPicture}" style="position:absolute;
		left:200px;
		top:50px;
		z-index:0;
		border: 2px solid grey;" width=75% height=350px   alt="[]" ></a>
		    
		    <a href="othersProfilePicture"><img src="data:image/jpeg;base64,${otherProfilePage.profilePicture}" style="position:relative;
		left:30px;
		top:30px;
		...
		z-index:1; color: white;">
       		${otherProfilePage.fullName}
    	</h2>
		<div class="container-fluid" >
					<div class="col-lg-9" style="padding:15px 15px 15px 15px;" align= right>
						<a href="updateInfo"> <button type="button" style="width:100px" name="Edit" value="Edit" id="Edit" class="btn btn-primary" disabled> Edit </button> </a>
					</div>
		</div>
	</div>
