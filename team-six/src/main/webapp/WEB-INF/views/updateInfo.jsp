...
<body>
		...
		<form name="project_form" id="project_form" action="/SE-project-team-six/update" enctype="multipart/form-data" method="POST">
			...
			<h5 class="text-left"><b>This section contains information provided on registration page which can be edited here </b></h5>
				<div class="form-group col-lg-6">
					...
					<input type="email" name="emailId" required class="form-control" id="emailId" value="${UserModel.emailId}" >
				</div>
				...
				<div class="form-group col-lg-6" >
					...
					<input type="password" name="password" required class="form-control" id="password" value="${UserModel.password}">
				</div>
			
			   		
				<div class="form-group col-lg-6" >
					<label for="dob">Date of Birth</label>
					<input type="text" name="dob" required class="form-control" id="dob" value="${UserModel.dob}">
				</div>
			    <div class="form-group col-lg-6" >
						
					<label for="gender">Gender</label>
					<input type="text" name="gender" required class="form-control" id="gender" value="${UserModel.gender}">
				</div>
			
			<div class="form-group col-lg-6" >
					<label for="securityQuestion1">Your mother's maiden name ?</label>
					<input type="text" name="securityQuestion1" required class="form-control" id="securityQuestion1" value="${UserModel.securityQuestion1}">
				</div>
				
				<div class="form-group col-lg-6" >
						
					<label for="securityQuestion2">Your father's maiden name ?</label>
					<input type="text" name="securityQuestion2" required class="form-control" id="securityQuestion2" value="${UserModel.securityQuestion2}">
				</div>
				</div>
			<div class="row col-lg-12">
	...
	<hr size="10" width="100%" noshade style="color:#000000" align="left" />
		...
		<div class="form-group col-lg-6" >
					...
					<input type="text" name="fullName" class="form-control" id="fullName" value="${UserModel.fullName}" placeholder="Enter Your Full Name">
				</div>
			    <div class="form-group col-lg-6" >
						
					<label for="school">School</label>
					<input type="text" name="school" required class="form-control" id="school" value="${UserModel.school}" placeholder="Enter Your School">
				</div>
				<div class="form-group col-lg-6" >
						
					<label for="phoneNumber">Phone number</label>
					<input type="text" name="phoneNumber" required class="form-control" id="phoneNumber" value="${UserModel.phoneNumber}" placeholder="Enter Your Phone Number">
				</div>
				<div class="form-group col-lg-6" >
						
					<label for="address">Address number</label>
					<input type="text" name="address" required class="form-control" id="address" value="${UserModel.address}" placeholder="Enter Your Address">
				</div>
