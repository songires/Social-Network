...
<body>
	...
	<div class="container" >
			...
			<div style="width:70%;height:350px;position:fixed;">
		 	...
		 	<a href="backgroundPicture"><img src="data:image/jpeg;base64,${UserModel.backgroundPicture}" style="padding-right:05px;" width="100%"  height="270px" alt="[]" ></a>
         	
         	</div>
         	<div style="width:15%;height:250px;position:fixed;">
    			<img src="data:image/jpeg;base64,${UserModel.profilePicture}" style="padding-left:15px;padding-top:20px;padding-right:05px;position:relative;z-index:-1" width="100%"  height="100%" alt="[]" />
    		</div>
         	</div>
	...
	<a href="<c:url value="/SE-project-team-six/test1/${UserModel.emailId}" />" >${UserModel.emailId}</a>
	<a href="/SE-project-team-six/test2?argName=kuachbi" >hello</a>
...
<div class="some">
<div style="float:left;line-height:35px;">
	<div  class="pre-scrollable" id="list" style="float:right;width:300px;height:700px;position:fixed;max-height:600px;">
		<div class="form-group col-lg-12">		
